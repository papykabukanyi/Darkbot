...
class IDSportsScraper(BaseSneakerScraper):
    """Scraper for idsports.com"""
    ...
    def search_products(self, keywords: List[str] = None, category: str = None) -> List[Dict]:
        """
        Search for products on idsports.com
        ...
        if category and category.lower() == 'sale':
            ...
            url = f"{self.base_url}/collections/shoes"
        ...
        # Note: Adjust selectors for idsports.com actual structure
