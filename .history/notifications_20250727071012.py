...
class EmailNotifier:
    ...
    def add_deals(self, deals: List[Dict[str, Any]]) -> None:
        ...
        # Only add worth_buying deals
        worthy_deals = [deal for deal in deals if deal.get('worth_buying', False)]
        
        if worthy_deals:
            self.pending_deals.extend(worthy_deals)
            logger.info(f"Added {len(worthy_deals)} deals to pending email notification.")
    ...
    def send_deals_email(self, deals: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            msg['Subject'] = f"Sneaker Deals Alert - {get_timestamp()}"
            ...
            for deal in deals:
                ...
                <div class="deal">
                    ...
                    <div style="margin-top: 10px;">
                        <a href="{deal.get('url', '#')}" class="button">View Deal</a>
                    </div>
                </div>
                """
